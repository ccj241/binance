            ...
            <div class="form-grid">
              ...
              <div class="form-group">
                ...
                <input
                    ...
                    @input="strategyForm.symbol = strategyForm.symbol.toUpperCase()"
                    class="form-control"
              ...
              <div class="form-group">
                ...
                <input
                    v-model.number="strategyForm.entryPrice"
                    type="number"
                    step="0.00000001"
                    placeholder="限价单价格"
                    class="form-control"
              ...
              <div class="form-group">
                <label class="form-label">开仓数量</label>
                <input
              ...
              <div class="form-group">
                <label class="form-label">止损百分比 (%) <span class="optional">可选</span></label>
                <input
              ...
              <div class="preview-grid">
                <div class="preview-item">
                  ...
                  <span class="preview-value">
                    {{ formatCurrency(strategyForm.entryPrice * strategyForm.quantity) }}
                  </span>
                </div>
                <div class="preview-item">
                  <span class="preview-label">所需保证金</span>
                  <span class="preview-value">
                    {{ formatCurrency((strategyForm.entryPrice * strategyForm.quantity) / (strategyForm.leverage || 1)) }}
                  </span>
                </div>
                <div class="preview-item">
...
export default {
  ...
  methods: {
    ...
    async submitStrategy() {
      ...
      try {
        if (this.editingStrategy) {
          // 更新策略
          await axios.put(`/futures/strategies/${this.editingStrategy.id}`, this.strategyForm);
          this.showToast('策略更新成功');
        } else {
          // 创建策略
          await axios.post('/futures/strategies', this.strategyForm);
    ...
    calculateTakeProfitPrice() {
      ...
      if (side === 'LONG') {
        return this.formatPrice(entryPrice * (1 + takeProfitRate / 100 + feeRate));
      } else {
        return this.formatPrice(entryPrice * (1 - takeProfitRate / 100 - feeRate));
      }
    },
    ...
    calculateStopLossPrice() {
      ...
      if (side === 'LONG') {
        return this.formatPrice(entryPrice * (1 - stopLossRate / 100));
      } else {
        return this.formatPrice(entryPrice * (1 + stopLossRate / 100));
      }
    },
