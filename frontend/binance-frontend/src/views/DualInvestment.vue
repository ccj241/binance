          ...
          <div v-for="strategy in strategies" :key="strategy.id" class="strategy-card">
            ...
            <div class="strategy-info">
              ...
              <div class="info-row" v-if="strategy.strategyType === 'ladder'">
                ...
                <span class="value">{{ strategy.ladderSteps }}层 / {{ strategy.ladderStepPercent }}%间隔</span>
              </div>
              <div class="info-row">
            ...
            <form @submit.prevent="saveStrategy" class="modal-body">
              <div class="form-grid">
                ...
                <template v-if="strategyForm.strategyType === 'ladder'">
                  <div class="form-group">
                    <label class="form-label">梯度层数</label>
                    <input
                  ...
                  <div class="form-group">
                    <label class="form-label">梯度间隔 (%)</label>
                    <input
                        v-model.number="strategyForm.ladderStepPercent"
                        type="number"
                        class="form-control"
                        min="0.1"
                        max="10"
        ...
        async saveStrategy() {
          try {
            ...
            if (formData.strategyType !== 'ladder') {
              ...
              delete formData.ladderStepPercent;
            }
